...
**Latest (v5.2.4):** Complete gitignore coverage — `kit init` now gitignores all generated artifacts (bridge dirs, `.worktreeinclude`) so `git status` stays clean. 1002 tests passing.
