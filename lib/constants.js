...
/** IDE bridge directory paths (shared between worktree.js and command-bridge.js) */
const IDE_BRIDGE_DIRS = Object.freeze({
  claude: '.claude/commands/',
  cursor: '.cursor/commands/',
  opencode: '.opencode/commands/',
  windsurf: '.windsurf/workflows/',
  vscode: '.github/prompts/',
});

/** IDE config paths Kit generates beyond bridge commands (for gitignore) */
const IDE_CONFIG_PATHS = Object.freeze({
  cursor: '.cursor/rules/',
