...
const PRIORITY_TIERS = Object.freeze({
  critical: Object.freeze(['project-status', 'help-kit', 'review', 'plan', 'test', 'pr', 'debug', 'greenfield', 'brownfield']),
  high: Object.freeze(['create', 'deploy', 'pr-review', 'pr-fix', 'preflight', 'enhance', 'implement']),
...
function cacheCommands(commands) {
  ...
  try {
    ...
    // Skip plugin commands that already exist in workflows
