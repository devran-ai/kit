...
const DOC_PATTERNS = Object.freeze([
  ...
  { test: /(?:^|\/)theme\//i, category: 'design-system', domains: ['frontend'], priority: 0 },
  { test: /(?:^|\/)styles\//i, category: 'design-system', domains: ['frontend'], priority: 0 },
  ...
  { test: /(?:^|\/)views\//i, category: 'screen-spec', domains: ['frontend'], priority: 1 },
  { test: /(?:^|\/)pages\//i, category: 'screen-spec', domains: ['frontend'], priority: 1 },
  { test: /(?:^|\/)layouts\//i, category: 'screen-spec', domains: ['frontend'], priority: 1 },
  ...
  { test: /(?:^|\/)features?\//i, category: 'epic', domains: ['planning'], priority: 1 },
